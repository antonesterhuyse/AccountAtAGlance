...
var sceneLayoutService = function () {
    var width,
        get = function () {
            ...
            //Items is an object literal which contains a property "tiles" which contains an array of objects, each with a set of properties 
            items = { tiles:
                    [
                    { name: 'Account Details',
                        tileId: 'AccountDetails',
                        formatter: tileFormatter.formatAccountDetails, //Assign a function to this property
                        scenes: [
