var sceneStateManager = function () {
    ...
    init = function(args) {
        ...
        //Add Events for the left and right slider click
    ...
    renderAccountTiles = function (data) {
        //Find all divs with class "tile" and id=Account?
        $('div.tile[id^="Account"]').each(function() {
            var tileDiv = $(this);  //get the DOM element and pass it into the jQuery constructor?
    ...
    swapTiles = function(source, target) {
        var sourceScene = source.data().scenes[sceneId]; //data() => gets the data object?
